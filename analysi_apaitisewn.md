...
Θα πρέπει να ελέγχουν την σύμφωνη με τους όρους και προὑποθέσεις συμπεριφορά των χρηστών του site. Αν κρίνουν ότι παραβιάζουν όρους θα μπορούν να ανακαλούν ρόλους και δικαιώματα αλλά ακόμα και να μπλοκάρουν χρήστες από την πλατφόρμα. 
...
Τέλος, ο διαχειριστής θα μπορεί να περιηγηθεί είτε ως γονέας είτε ως πάροχος μέσα στην πλατφόρμα.
